...
print("Max_Length : ",max_length) #54
...
with open("Project_Saved_Models/tokenizer_gru.pickle",'wb') as handle:
...
checkpoint=ModelCheckpoint("Project_Saved_Models/gru_model.h5",monitor="accuracy",save_best_only=True,verbose=1)#when training deep learning model,checkpoint is "WEIGHT OF THE MODEL"
